...
namespace JiebaNet.Segmenter.FinalSeg
{
    public class Viterbi : IFinalSeg
    {
        ...
        private void LoadModel()
        {
            ...
            var transJson = OYMLCN.Word.Resources.prob_trans_json.GZipDecompress().ConvertToString();
            ...
            var emitJson = OYMLCN.Word.Resources.prob_emit_json.GZipDecompress().ConvertToString();
