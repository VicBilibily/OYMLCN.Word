...
namespace JiebaNet.Segmenter.PosSeg
{
    public class Viterbi
    {
        ...
        private static void LoadModel()
        {
            ...
            var startJson = OYMLCN.Word.Resources.pos_prob_start_json.GZipDecompress().ConvertToString();
            ...
            var transJson = OYMLCN.Word.Resources.pos_prob_trans_json.GZipDecompress().ConvertToString();
            ...
            var emitJson = OYMLCN.Word.Resources.pos_prob_emit_json.GZipDecompress().ConvertToString();
            ...
            var tabJson = OYMLCN.Word.Resources.char_state_tab_json.GZipDecompress().ConvertToString();
